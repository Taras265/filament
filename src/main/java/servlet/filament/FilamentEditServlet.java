...
@WebServlet("/edit")
public class FilamentEditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (filamentOpt.isPresent()) {
            ...
            req.getRequestDispatcher("/WEB-INF/jsp/filament/edit.jsp").forward(req, resp);
        } else {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        Filament filament = new Filament(color, maxWeight, weight, maxLength, length, filamentType, company, url);
        filament.setId(id);
